...
package com.wxkj.tongcheng.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        maskColor = ContextCompat.getColor(getContext(), R.color.color_translucent);
        resultColor = ContextCompat.getColor(getContext(), R.color.color000);
        resultPointColor = ContextCompat.getColor(getContext(), R.color.colorfb105);
        statusColor = ContextCompat.getColor(getContext(), R.color.color333);
    ...
    private void initPaint() {
        ...
        scanLinePaint.setColor(ContextCompat.getColor(getContext(), R.color.color_ff8b56));
