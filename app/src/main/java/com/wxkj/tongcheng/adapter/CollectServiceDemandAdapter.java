...
public class CollectServiceDemandAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<CollectServiceBean> list;

    public CollectServiceDemandAdapter(Context context, List<CollectServiceBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        CollectServiceBean bean = list.get(position);
        //有图
//        if (holder instanceof MyImgView){
//            MyImgView view= (MyImgView) holder;
//            view.title_text.setText(bean.getTitle());
...
//        }
    ...
    public int getItemViewType(int position) {
        return TextUtils.isEmpty(list.get(position).getPic())?1:0;
    }
