package com.wxkj.tongcheng.view.imageView;
...
import com.wxkj.tongcheng.util.UriUtils;
...
public class ClipViewLayout extends RelativeLayout {
    ...
    public static int calculateInSampleSize(BitmapFactory.Options options,
        ...
        if (height > reqHeight || width > reqWidth) {
            ...
            // guarantee
            // OnRequestListener final image with both dimensions larger than or equal to the
